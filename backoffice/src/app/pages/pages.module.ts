...
import {
  ...
  NbButtonModule, NbCardModule, NbDatepickerModule, NbDialogModule, NbFormFieldModule,
  NbIconModule, NbInputModule, NbLayoutModule, NbMenuModule,
  NbOverlayModule, NbSelectModule, NbSidebarModule, NbSpinnerModule, NbTableModule,
...
@NgModule({
  declarations: [HomeComponent, SidebarMenuComponent, PaiementComponent, ListPaiementComponent,
    AlertComponent, ClientComponent,
    ListClientComponent, PartnerComponent, ListPartnerComponent,
    DashboardComponent, TransactionChartComponent, ChartHeaderComponent,
    ModalComponent, SearchClientComponent, SearchPaiementComponent, SearchPartnerComponent, LoaderComponent
  ],
  exports: [
    HomeComponent
  ],
